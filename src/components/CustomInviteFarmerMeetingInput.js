...
const CustomInviteFarmerMeetingInput = ({ validationsBorder, valueHandle, name, data, label, inputValue, handleDropDown, dropDownVisible, closeDropDown }) => {
    const fonts=useFontStyles()
    const renderList = (item) => {
        console.log("item-==-=->",item.item)
        return (
            <TouchableOpacity onPress={() => valueHandle(item.item.productName, item.item.hybridList)} style={RnStyles.labelContainer}>
...
export default CustomInviteFarmerMeetingInput
