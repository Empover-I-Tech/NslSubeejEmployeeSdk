...
function CustomFertilizerTextInput({ props, 
    labelName, 
    IsRequired, 
    defaultValue,
    value, 
            ...
            removeClippedSubviews={true}>
                ...
                <View
                    ...
                    <TextInput 
                        ...
                        // ,
                        {color:dynamicStyles?.textColor ??"#000",fontSize:14,textAlign:"left",width:"100%" ,padding: 0, paddingLeft: 0, width: labelName == strings.mobile_number ? "85%" : "95%", height: labelName == strings.address && value?.length > 50 ? 60 : 40, paddingEnd: labelName == strings.address ? 15 : 0 }]}
...
export default CustomFertilizerTextInput;
