...
const CustomFertilizerCalBorderInputDropDown = (props) => {
            ...
            <View style={{ marginBottom: 5 }}>
                {props.labelName !== undefined && (
                    <Text
                        ...
                        {props.labelName}
                        {props.IsRequired && (
                            <Text style={[styles['text_color_red'],{fontFamily:fonts.Regular}]}> {"*"}</Text>
                        )}
                    </Text>
                )}
                {/* {props.labelName !== undefined && (
                    ...
                    <TouchableOpacity disabled={ props?.disabled?true:false}
                        ...
                        <TextInput
                            style={[
                                ...
                                props?.disabled && { backgroundColor: 'E9E9E9',fontFamily:fonts.Regular },
                                // styles['padding_left_10'],
                                // Platform.OS === 'ios' && styles['top_3'],
                                // styles['width_92%'],
...
export default CustomFertilizerCalBorderInputDropDown;