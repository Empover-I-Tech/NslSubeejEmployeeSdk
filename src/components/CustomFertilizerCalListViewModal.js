...
const CustomFertilizerCalListViewModal = ({
    visible,
    onBackdropPress,
    closeModal,
    listItems,
    ...
    console.log("KIRAN=-=-=-=-SAI=-=-=->",filteredList)
                            ...
                            renderItem={({ item,index }) => (
                                <TouchableOpacity onPress={() => onPressDropdownItem(item)}>
                                    <View style={Rnstyles.flatListRenderStyles}>
                                        <Text style={[{color:selectedItem === item.name ?'#378CE7':"#000",fontFamily:fonts.Regular} ,
                                            //  styles['text_input'],
                                             ]} numberOfLines={3}>
...
export default CustomFertilizerCalListViewModal;
