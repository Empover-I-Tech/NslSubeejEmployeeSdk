...
const CustomYieldCalListViewModal = ({
    visible,
    onBackdropPress,
    closeModal,
    listItems,
                            ...
                            renderItem={({ item,index }) => (
                                <TouchableOpacity onPress={() => onPressDropdownItem(item)}>
                                    <View style={Rnstyles.flatListRenderStyles}>
                                        <Text style={[{color:selectedItem === item.name ?'#378CE7':"#000",fontFamily:fonts.Medium,fontSize:14} ,
                                            //  styles['text_input'],
                                             ]} numberOfLines={3}>
...
export default CustomYieldCalListViewModal;
