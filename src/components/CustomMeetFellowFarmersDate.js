...
const CustomMeetFellowFarmersDate = ({ closeDate, validationBorder, label, inputValue, handleModal, onSelectDate, visible }) => {
...
export default CustomMeetFellowFarmersDate
