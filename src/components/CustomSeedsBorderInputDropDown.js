...
const CustomSeedsBorderInputDropDown = (props) => {
        ...
        <View
            ...
            <View style={{ marginBottom: 5 }}>
                {props.labelName !== undefined && (
                    <Text style={[styles.textColorBlack, styles.white_bg, { position: "absolute", marginTop: -10, marginLeft: 15, padding: 5 }]}
                    // style={[
                ...
                <View style={[{ flexDirection: "row", width: "99%" }]}>
                    <TouchableOpacity
                        style={[
                            ...
                            { width: "100%", flexDirection: "row", top: 5, borderWidth: 1, borderRadius: 6, borderColor: "grey", height: 45 },
                        ...
                        <TextInput
                            style={[
                                ...
                                { color: dynamicStyles?.textColor ?? "black", paddingLeft: 10 },
                                // styles['padding_left_10'],
                                Platform.OS === 'ios' && styles['top_3'],
                                // styles['width_92%'],
                                { color: "grey", padding: 0, width: "92%", fontSize: 14,}
                            ]}
                            value={props.value}
...
export default CustomSeedsBorderInputDropDown;