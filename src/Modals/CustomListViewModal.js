                ...
                <View style={[styles['width_85%'], styles['border_radius_normal'], styles['padding_10'], styles['margin_30'], styles['max_height_80%'], styles['bg_white']]}> 
                    <View style={[styles['align_self_flex_end'], styles['top_5']]}>
                        <TouchableOpacity onPress={closeModal}>
                            <Image source={require('../assets/images/close.png')} style={[styles['width_height_25'], { tintColor: dynamicStyles.primaryColor }]} />
                        </TouchableOpacity>
                    </View>
                    {filteredList?.length > 0 ? (
                            ...
                            renderItem={({ item }) => (
                                <TouchableOpacity onPress={() => onPressDropdownItem(item)}>
                                    <View style={[styles['width_100%'], styles['top_10']]}>
                                        <Text style={[selectedItem === item.name ? styles['text_color_blue'] : {color:dynamicStyles.textColor}, styles['text_input'], styles['padding_5'],{fontFamily:fonts.Regular,fontSize:13}]} numberOfLines={3}>
                        ...
                        <View>
                            <Text style={[styles['text_color_black'], styles['centerItems'], styles['margin_top_80'], { height: 40,fontFamily:fonts.SemiBold }]}>{strings.no_data_available}</Text>
                        </View>
                    )}
                </View>
            </View>
